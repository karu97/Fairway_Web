  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-16">
      ...
      <div className="text-center">
        ...
        <h2 className="mt-2 text-2xl md:text-3xl font-serif text-black">Our Leadership</h2>
        <p className="mt-2 text-sm text-black/60 max-w-2xl mx-auto">Experienced leaders dedicated to elevating Sri Lankan hospitality with design, care, and innovation.</p>
      </div>
