  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-16">
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-black/60 max-w-2xl mx-auto">Meet C. Weerasinghe (Chairman & Managing Director) and P.S.Gunawardene (Director) - experienced leaders dedicated to elevating Sri Lankan hospitality with design, care, and innovation.</p>
      </div>
