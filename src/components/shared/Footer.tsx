      ...
      <div className="mx-auto max-w-7xl px-4 pt-12 pb-6 grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div>
          ...
          <form className="mt-3 flex gap-2">
            <input type="email" placeholder="Your email" className="w-full border border-black/20 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-black/20" />
