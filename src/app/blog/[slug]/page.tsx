  ...
  return (
    <MainLayout>
      <article className="mx-auto max-w-3xl px-4 py-12">
        <header>
          <h1 className="text-3xl font-serif capitalize">{slug.replace(/-/g, " ")}</h1>
          <p className="text-black/60 mt-2 text-sm">Published on 16 Oct 2025</p>
        </header>
        <div className="prose prose-neutral mt-6 max-w-none">
          ...
          <h2>Designing for Tranquility</h2>
          <p>
